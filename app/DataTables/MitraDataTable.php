...
class MitraDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('mitra', function ($data) {
                return '<small>'.$data->mitra.'<br/>'.$data->telepon.'</small>';
            })
            ->editColumn('alamat', function ($data) {
                return '<small>'.$data->alamat.'</small>';
            })
            ->editColumn('marketing', function ($data) {
                return '<small>'.$data->marketing.'</small>';
            })
            ->rawColumns(['type', 'marketing', 'alamat', '#', 'mitra'])
            ->setRowId('id');
    }
