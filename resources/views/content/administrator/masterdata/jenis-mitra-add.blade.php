...
<div class="card">
  ...
  <form id="form" class="mb-0" action="{{ route('jenis-mitra.store') }}" method="POST">
    @csrf
    <div class="mx-4">
      <div class="row g-3">
        <div class="col-6 mb-3">
          <label for="jenis_mitra" class="form-label">JENIS MITRA</label>
          <input type="text" id="jenis_mitra" name="jenis_mitra" class="form-control" placeholder="Arsitek, Desain interior, dll." autofocus/>
        </div>
      </div>
      <div class="row g-3">
        <div class="col mb-3">
          <label for="keterangan" class="form-label">KETERANGAN</label>
          <textarea rows="10" cols="100" id="keterangan" name="keterangan" class="form-control" placeholder="Berikan keterangan mengenai data masukan."></textarea>
        </div>
      </div>
    </div>
