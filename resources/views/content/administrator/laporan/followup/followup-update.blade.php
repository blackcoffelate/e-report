...
<div class="card">
  ...
  <form id="form" class="mb-0" action="{{ route('laporan-followup.put', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="mx-4">
      <div class="row g-3">
      ...
      <div class="row g-3">
        <div class="col-4 mb-3">
          ...
          <input type="text" value="{{$data->tahun}}" id="tahun" name="tahun" class="form-control" placeholder="Masukan tahun nota">
        </div>
        <div class="col-4 mb-3">
      ...
      <div class="row g-3">
        <div class="col mb-3">
          ...
          <textarea rows="5" cols="50" id="keterangan" name="keterangan" class="form-control" placeholder="Berikan keterangan mengenai data masukan." value="{{$data->keterangan}}">{{$data->keterangan}}</textarea>
        </div>
      </div>
    </div>
